...
class AMScheduler < MiniTest::Test
  ...
  def test_it_can_resolve_uuid_in_unbound_queries_for_more_than_one_resources
    ...
    n2 = OMF::SFA::Model::Node.create(name: 'omf.nitos.node002', account: @scheduler.get_nil_account, domain: "domain1", exclusive: true)
    t1 = Time.now
  ...
  def test_it_can_resolve_urn_in_unbound_queries_for_more_than_one_resources
    n1 = OMF::SFA::Model::Node.create(name: 'omf.nitos.node001', account: @scheduler.get_nil_account, domain: "domain1", urn: "domain1:n1", exclusive: true)
    n2 = OMF::SFA::Model::Node.create(name: 'omf.nitos.node002', account: @scheduler.get_nil_account, domain: "domain1", urn: "domain1:n2", exclusive: true)
    t1 = Time.now
  ...
  def test_it_can_resolve_exclusive_in_unbound_queries_based_on_already_given_exclusive
    ...
    n1 = OMF::SFA::Model::Node.create(name: 'omf.nitos.node001', account: @scheduler.get_nil_account, domain: "domain1", exclusive: true)
    n2 = OMF::SFA::Model::Node.create(name: 'omf.nitos.node002', account: @scheduler.get_nil_account, domain: "domain1", exclusive: true)
    n3 = OMF::SFA::Model::Node.create(name: 'omf.nitos.node003', account: @scheduler.get_nil_account, domain: "domain2", exclusive: false)
    t1 = Time.now
  ...
  def test_it_can_resolve_domain_in_unbound_queries
    n1 = OMF::SFA::Model::Node.create(name: 'omf.nitos.node001', account: @scheduler.get_nil_account, domain: "domain1", exclusive: true)
    n2 = OMF::SFA::Model::Node.create(name: 'omf.nitos.node002', account: @scheduler.get_nil_account, domain: "domain1", exclusive: true)
    n3 = OMF::SFA::Model::Node.create(name: 'omf.nitos.node003', account: @scheduler.get_nil_account, domain: "domain2", exclusive: true)
  ...
  def test_it_throws_exception_when_there_are_no_available_resources_on_the_same_domain
    n1 = OMF::SFA::Model::Node.create(name: 'omf.nitos.node001', account: @scheduler.get_nil_account, domain: "domain1", exclusive: true)
    n2 = OMF::SFA::Model::Node.create(name: 'omf.nitos.node002', account: @scheduler.get_nil_account, domain: "domain2", exclusive: true)
  ...
  def test_it_throws_exception_when_there_are_no_available_resources_with_the_asked_exclusiveness
    n1 = OMF::SFA::Model::Node.create(name: 'omf.nitos.node001', account: @scheduler.get_nil_account, domain: "domain1", exclusive: false)
